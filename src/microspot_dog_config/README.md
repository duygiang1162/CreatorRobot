...
#### 1.1.1. Run the base driver:
    ...
    roslaunch microspot_dog_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch microspot_dog_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch microspot_dog_config slam.launch rviz:=true
...
- Save the map by running:
      ...
      roscd microspot_dog_config/maps
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch microspot_dog_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch microspot_dog_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
